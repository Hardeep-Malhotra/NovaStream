...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, {}, "Passwrod changed successfully."))
...
const updateUserAvater = asyncHandler(async (req, res) => {
    ...
    if (!avatar) {
        throw new ApiError(400, "Error occur while uploading on  avatar.");
    };
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (!coverImage.url) {
        throw new ApiError(500, "Error occurred while uploading cover image.");
    }
...
export {
    ...
    updateUserAvater,updateUserCoverImage
};
